...
const Input = (props: Props) => {
  ...
  return (
    <form onSubmit={handleSubmit} className='min-h-[80px] flex gap-3 items-center justify-center w-full' >
      <input value={prompt} onChange={(e:ChangeEvent<HTMLInputElement>)=>setPrompt(e.target.value)} name='prompt' className='bg-transparent outline-transparent min-h-[40px] w-[270px] rounded-xl rounded-ee-none border-2 p-2 border-[#404040] focus:outline-0 focus:border-[#63b3ed]' type="text" placeholder='Message...' />
